...
class SelfAttention(nn.Module):
    def __init__(self, cfg, optim_spec=None):
        ...
        self.H2 = torch.nn.Conv2d(feat_dim, feat_dim, kernel_size=1, padding=0, stride=1, bias=False)
        ...
        self.H3 = torch.nn.Conv2d(feat_dim, feat_dim, kernel_size=1, padding=0, stride=1, bias=False)
        ...
        self.H4 = torch.nn.Conv2d(feat_dim, feat_dim, kernel_size=1, padding=0, stride=1, bias=False)
